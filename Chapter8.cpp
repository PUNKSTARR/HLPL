...
{     
  ...
  swap_v(7,9); //will not work bcs arguments are integers, not variables        
  cout <<2 << x << ' '<< y << endl; //it will print out result of first function
  ...
  cout << 4 <<dx << dy << endl; ////it will print out original values
